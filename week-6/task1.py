...
cars = []
with open('week-6/files/Price_table.csv') as f:
...
with open('week-6/files/normalized.txt', 'w') as f:
    for line in normalize(prices):
        f.write(str(line) + '\n')

data = pd.read_csv('week-6/files/Price_table.csv')
...
print('Year sd:', data['Year'].std())
print('Entry price sd:', data['Entry_price'].std())
